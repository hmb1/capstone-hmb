...
def add_points(idx,add=1):
       ...
       0.899852, 0.403664])]
        ...
        if add >= 12:            
            X12 = [np.array([0.554688, 0.53581 ]), np.array([0.185302, 0.229914]), np.array([0.949319, 0.056592, 0.00769 ]), np.array([0.835459, 0.968147, 0.84, 0.856453]), np.array([0.013688, 0.053408, 0.019874, 0.908796]), np.array([0.001819, 0.959575, 0.030757, 0.019916, 0.95011 ]), np.array([0.927403, 0.01649 , 0.390566, 0.891934, 0.541361, 0.404138]), np.array([0.802148, 0.58537 , 0.988903, 0.912894, 0.152431, 0.990657,0.997486, 0.662685])]
